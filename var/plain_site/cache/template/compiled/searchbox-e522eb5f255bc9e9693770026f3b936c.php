...
$oldSetArray_cf9a79d8d3e0753d270a544862da6307 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '">
<div class="label">Recherche : </div><div class="search-line"><form action="/index.php/content/search" method="get"><input class="searchinput" type="text" size="10" name="SearchText" value="" />
...
$setArray = $oldSetArray_cf9a79d8d3e0753d270a544862da6307;
$tpl->Level--;
?>
