<?php
// URI:       design/standard/templates/toolbar/line/login.tpl
// Filename:  design/standard/templates/toolbar/line/login.tpl
// Timestamp: 1342179298 (Fri Jul 13 13:34:58 CEST 2012)
$oldSetArray_b8096a085ce7af4129b7e85884552950 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '<a href="/index.php/user/login">Ouverture de session</a>&nbsp;';
}
else
{
$text .= '<a href="/index.php/user/logout">Fermeture de session(';
unset( $var );
unset( $var1 );
unset( $var1 );
...
$setArray = $oldSetArray_b8096a085ce7af4129b7e85884552950;
$tpl->Level--;
?>
