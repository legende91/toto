...
$oldSetArray_839889993e32b141e9c385115136163f = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$subtreeExpiry = NULL;
$cacheKeys = array( $cacheKeys, "1_0_1_48_design/standard/templates/dashboard/latest_content.tpl", "plain_site_admin" );
...
$setArray = $oldSetArray_839889993e32b141e9c385115136163f;
$tpl->Level--;
?>
