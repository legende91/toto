...
$oldSetArray_2e02a806345f5cda60bca5378293ae60 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$subtreeExpiry = NULL;
$cacheKeys = array( $cacheKeys, "3_0_3_36_design/standard/templates/dashboard/all_latest_content.tpl", "plain_site_admin" );
...
$setArray = $oldSetArray_2e02a806345f5cda60bca5378293ae60;
$tpl->Level--;
?>
