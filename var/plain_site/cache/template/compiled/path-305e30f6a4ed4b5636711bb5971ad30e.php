<?php
// URI:       design/base/templates/parts/path.tpl
// Filename:  design/base/templates/parts/path.tpl
// Timestamp: 1342179294 (Fri Jul 13 13:34:54 CEST 2012)
$oldSetArray_5e54de5909666d51e543b92c4ca56bb9 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$if_cond2 = compiledFetchAttribute( $if_cond1, 'url_alias' );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
...
$setArray = $oldSetArray_5e54de5909666d51e543b92c4ca56bb9;
$tpl->Level--;
?>
