...
$oldSetArray_df406ef73524fad376d337e3dd065032 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<head>';
$oldRestoreIncludeArray_a04ecabc912a3c9adce1669408128caa = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/cache/template/compiled/page_head-221111cd9c315a1714bf196673a65d05.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/cache/template/compiled/page_head-221111cd9c315a1714bf196673a65d05.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_a04ecabc912a3c9adce1669408128caa;

$text .= '
<script type="text/javascript" src="/design/standard/javascript/tools/ezjsselection.js"></script>';
$loopItem = array (
);
...
<div id="logo">
<img src="/design/admin/images/ezpublish-logo-4-symbol.gif" width="256" height="40" alt="eZ Publish" border="0" />
<p>version ';
unset( $var );
...
';
$oldRestoreIncludeArray_cb6cfc8f2cc04ea9d21b57acd2912bb9 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/cache/template/compiled/page_mainarea-0137c566f55263e9aa6c3becd8105497.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/cache/template/compiled/page_mainarea-0137c566f55263e9aa6c3becd8105497.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_cb6cfc8f2cc04ea9d21b57acd2912bb9;
...
';
$oldRestoreIncludeArray_0185eb9291ddd1d5f24395a947f905cb = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/cache/template/compiled/page_copyright-e1a35bea6d490d350e39a294e7d9c8a7.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/cache/template/compiled/page_copyright-e1a35bea6d490d350e39a294e7d9c8a7.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_0185eb9291ddd1d5f24395a947f905cb;
...
$setArray = $oldSetArray_df406ef73524fad376d337e3dd065032;
$tpl->Level--;
?>
